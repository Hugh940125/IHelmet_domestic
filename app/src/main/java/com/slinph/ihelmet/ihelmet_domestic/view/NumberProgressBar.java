...
//            canvas.drawRect(mReachedRectF, mReachedBarPaint);
        ...
        if (mIfDrawText){
            if(mCurrentProgress>9){
                canvas.drawText(mCurrentDrawText, mDrawTextStart-dp2px(11), mDrawTextEnd-dp2px(20), mTextPaint);
            }else{
                canvas.drawText(mCurrentDrawText, mDrawTextStart-dp2px(7), mDrawTextEnd-dp2px(20), mTextPaint);
            }
            //canvas.drawBitmap(mBitmap, mDrawTextStart-dp2px(11), mDrawTextEnd-dp2px(35), mBitmapPaint);
        }
    }
