...
import com.slinph.ihairhelmet4.activity.FollowUpActivity;
import com.slinph.ihairhelmet4.activity.ImagePagerActivity;
            ...
            switch (requestCode){
                ...
                case 4:
                    ...
                    if("content".equals(scheme)){
                        ...
                        Cursor c = mContext.getContentResolver().query(localUri, filePathColumns, null, null, null);
                        if (c != null){
                            c.moveToFirst();
                    ...
                    Bitmap scaleBitmap = getScaleBitmap(mContext, imagePath);
                    new_check1.setImageBitmap(scaleBitmap);
